...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_often__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_often___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_often__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_debug__ = __webpack_require__(327);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_debug___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_debug__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_energy__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_energy___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_energy__);




const log = __WEBPACK_IMPORTED_MODULE_1_debug___default()('jsrenderer');
const emitter = __WEBPACK_IMPORTED_MODULE_2_energy___default()();
/**
  ...
  return fetch('/admin/pages/getJsRenderJob', {
    ...
    if (job) {
      ...
      try {
        ...
        processingJob.onmessage = (...args) => saveHtmlToCache.apply(this, args).then(() => log('finished saving render')).error(e => log('error saving render', e));
...
if (global.window.Worker) {
  const heartbeat = __WEBPACK_IMPORTED_MODULE_0_often___default()(function () {
